 ...
 */
var schemaQuery = function (projectName, datasetName, tableName) { return __awaiter(void 0, void 0, void 0, function () {
    var query, job, rows, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                return [2 /*return*/, 'Invalid Input: input is ' + err_1];
